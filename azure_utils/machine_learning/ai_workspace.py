...
from azure_utils.machine_learning.deep.create_deep_model import create_deep_model, develop_model_driver, get_or_create_resnet_image, \
...
class RTSWorkspace(AILabWorkspace):
    ...
    def get_or_create_image(**kwargs) -> Image:
        ...
        """
        return get_or_create_lightgbm_image(**kwargs)
...
class DeepRTSWorkspace(AILabWorkspace):
    ...
    def get_or_create_image(**kwargs):
        ...
        :return: Image from Workspace
        """
        get_or_create_resnet_image(**kwargs)
